...
{
    public partial class InstallCreateUserSuresh : System.Web.UI.Page
    {
               ...
               // rqPenalty.Enabled = false;
                ...
                if (Request.QueryString["ID"] != null)
                {
                    ...
                    if (ds.Tables[0].Rows.Count != 0)
                    {
                        ...
                        txtHomeZip.Text = ds.Tables[0].Rows[0][11].ToString();
        ...
        //    dtLastDate.Text = "";
        //    txtPayRates.Text = txtfirstname.Text = txtlastname.Text = dtResignation.Text = txtemail.Text = txtpassword.Text = txtpassword1.Text = txtPhone.Text = txtHomeZip.Text = txtState.Text = txtCity.Text = txtaddress.Text = null;
        //    gvUploadedFiles.Visible = false;
        ...
        protected void txtHomeZip_TextChanged(object sender, EventArgs e)
        {
            if (txtHomeZip.Text == "")
            {
                //
            ...
            else
            {
                ...
                ds = UserBLL.Instance.fetchcitystate(txtHomeZip.Text);
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                ...
                string str = ((txtCity.Text != "") ? txtCity.Text : "") + ((txtState.Text != "") ? ", " + txtState.Text : string.Empty) + ((txtHomeZip.Text != "") ? ", " + txtHomeZip.Text : string.Empty);
                Session["Zip"] = str.ToString();
                ViewState["zipEsrow"] = txtHomeZip.Text;
            }
        }
        ...
        private void GeneratePDF()
        {
            ...
            if (File.Exists(Server.MapPath(TargetPath)))
            {
                ...
                this.FindAndReplace(wordApp, "lblZIP1", txtHomeZip.Text);
        ...
        protected void lnkW4_Click(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            var pdfContents = PDFHelper.GeneratePDF("", formFieldMap);
            string fileName = "pdfDocument" + DateTime.Now.Ticks + ".pdf";
            string PdflDirectory = Server.MapPath("/PDFS");
        ...
        protected void ddldesignation_SelectedIndexChanged1(object sender, EventArgs e)
        {
            ...
            //        PageData = PageData + "," + txtHomeZip.Text;
